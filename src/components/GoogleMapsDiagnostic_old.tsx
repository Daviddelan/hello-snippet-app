  ...
  useEffect(() => {
    const checkGoogleMapsAPI = async () => {
      try {
        ...
        // Try to load the Google Maps API        const script = document.createElement('script');
        ...
        const loadPromise = new Promise((resolve, reject) => {
          ...
          // Set up the callback
          (window as any).initGoogleMapsTest = () => {
            try {
      ...
      <div className="space-y-4">
        ...
        {status.error && (
          <div className="mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <h4 className="font-medium text-blue-800 mb-2">Common Solutions:</h4>            <ul className="text-blue-700 text-sm space-y-1">
